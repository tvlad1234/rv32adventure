...
RV_CFLAGS+=-g -Os -march=rv32i -mabi=ilp32 -nostdlib 

RV_LDFLAGS:= -T rv_app_src/flatfile.lds -Wl,--gc-sections -lgcc

rv_app.elf : rv_app_src/main.c rv_app_src/barelibc.c
